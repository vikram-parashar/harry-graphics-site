...
export default function ProductItem({
  ...
  useEffect(() => {
    ...
    if (product.options) {
      Object.keys(selectedOptions).forEach((key) => {
        const option = productOptions[key].find(
          (opt) => opt.name === selectedOptions[key]
        )
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-10  lg:mx-30 lg:gap-10">
      ...
      <div className="lg:w-1/2 relative pb-20">
        ...
        <div className="max-h-90 overflow-y-scroll">
          <OptionsSection
            ...
            options={product.options as ProductOptionType}
          />
        </div>
        ...
        <div className="absolute bottom-0 left-0">
          <span className="text-sm text-muted-foreground block font-bold">
            Price
          </span>

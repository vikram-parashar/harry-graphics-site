...
export default function Footer() {
  return (
    <div className="bg-secondary-background text-background px-5 pt-16 lg:text-2xl border-t-5 border-b-5">
      <div className="lg:mx-auto lg:flex gap-10 lg:w-[90%]">
        ...
        <div className="mb-8 lg:w-1/3">
          {/* Contact */}
          <h5 className="font-bold border-b-2 border-background">
            <Contact className="inline mr-2 relative -top-1" />
            CONTACTS
          </h5>
          ...
          {/* Address */}
          <h5 className="font-bold border-b-2 border-background">
            <MapPinHouse className="inline mr-2 relative -top-1" />
            ADDRESS
          </h5>
          <p className="leading-7">
            1324, Street No. 16, Subhash Colony, Sector 60, Ballabgarh,
            Faridabad - 121004, Haryana, India
          </p>
        </div>
        <div className="lg:w-1/3">
          <h5 className="font-bold border-b-2 border-background">
            <ExternalLink className="inline mr-2 relative -top-1" />
            Links
          </h5>
      ...
      <p className="text-center mt-5">
        Copyright © {new Date().getFullYear()} Harry Graphics. All rights
        reserved.
      </p>
    </div>
  )

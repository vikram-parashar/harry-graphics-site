  ...
  return (
    <div className="bg-rosePine-base text-rosePine-text px-5 py-16">
      ...
      <div className="lg:ml-1/3 my-8 flex max-w-6xl pl-2 lg:mx-auto lg:mt-4 lg:pl-14">
        <svg className="fill-rosePine-iris mr-8 h-6 w-6" viewBox="0 0 20 20">
          <path
        ...
        <svg className="mr-8 h-6 w-6 fill-rosePine-rose" viewBox="0 0 20 20">
          <path
            d="M11.344,5.71c0-0.73,0.074-1.122,1.199-1.122h1.502V1.871h-2.404c-2.886,0-3.903,1.36-3.903,3.646v1.765h-1.8V10h1.8v8.128h3.601V10h2.403l0.32-2.718h-2.724L11.344,5.71z"
          ></path>
        </svg>
        <svg className="mr-8 h-7 w-7 fill-rosePine-pine" viewBox="0 0 20 20">
          <path

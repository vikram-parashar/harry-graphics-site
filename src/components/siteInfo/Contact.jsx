...
import contactImg from "../../assets/images/contactus.avif";
  ...
  return (
    <div className="bg-oceanLight">
      ...
      <div className="mx-auto mb-16 max-w-md px-5 lg:hidden">
        ...
        {/* Image */}
        <img className="" src={contactImg} alt="main" />
      </div>
      ...
      <div className="relative mx-auto mt-24 hidden max-w-[1280px] px-5 lg:block">
        ...
        <div className="flex">
          {/* Left side */}
          <div className="flex w-[45%] flex-col justify-end">
            {/* seprator */}
          ...
          {/* Right side */}
          <img className="pl-24" src={contactImg} alt="main" />
        </div>
        {/* social icons */}

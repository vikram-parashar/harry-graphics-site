...
export default function Page() {
  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-3 lg:space-y-8 p-10 h-full flex flex-col">
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input placeholder="O-namae wa?" {...field} className='shadow-shadow lg:text-2xl lg:h-16' type='text' />
              </FormControl>
            ...
            <FormItem className='relative'>
              ...
              <FormControl>
                <Input placeholder="jhon@doe.com"
                  {...field} className='shadow-shadow lg:text-2xl lg:h-16 ' type='email' />
              </FormControl>
              {/* <FormDescription>This is your public display name.</FormDescription> */}
              <FormMessage />
            </FormItem>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem className='relative'>
              ...
              <span className='absolute lg:text-2xl top-[50px] lg:top-[55px] left-3'>
        ...
        <div>
          <div className='flex items-center justify-center gap-5 '>
            ...
            <span>OR</span>
            <svg onClick={signupWithGoogle} xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" className="lg:w-30 lg:h-30 w-20 h-20 cursor-pointer" viewBox="0 0 100 100">
          ...
          <Link href={`/auth/login?redirectTo=${params.get("redirectTo") || '/explore'}`} className='text-center text-lg block lg:text-2xl'>Already have an account? Login</Link>
        </div>
      </form>
    </Form >
  );

...
export default function Page() {
  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-3 lg:space-y-8 p-5 mt-10 h-full flex flex-col">
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input placeholder="O-namae wa?" {...field} className='shadow-shadow lg:text-xl lg:h-12' type='text' />
              </FormControl>
            ...
            <FormItem className='relative'>
              ...
              <FormControl>
                <Input placeholder="jhon@doe.com"
                  {...field} className='shadow-shadow lg:text-xl lg:h-12 ' type='email' />
              </FormControl>
              {/* <FormDescription>This is your public display name.</FormDescription> */}
              <FormMessage />
            </FormItem>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem className='relative'>
              ...
              <FormControl>
                <Input placeholder="Top Secret Confirmed" {...field} className='shadow-shadow lg:text-xl lg:h-12' type={confirmPasswordVisible ? 'text' : 'password'} />
              </FormControl>
              {/* <FormDescription>This is your public display name.</FormDescription> */}
              <FormMessage />
            </FormItem>
        ...
        <div>
          ...
          <Link href={`/auth/login?redirectTo=${params.get("redirectTo") || '/explore'}`} className='text-center text-lg block lg:text-xl'>Already have an account? Login</Link>
        </div>
      </form>
    </Form >
  );

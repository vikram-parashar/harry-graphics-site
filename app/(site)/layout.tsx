...
export default async function RootLayout({
  ...
  return (
    <div>
      ...
      <div className="mx-auto lg:w-[90vw] mb-10">{children}</div>
      <Link
        href="https://wa.me/9891553224?text=Hi,%20I%20came%20from%20your%20website.%20I%20wanna%20know%20about..."
        className="fixed bottom-5 right-5 w-16 h-16 z-50"
        target="_blank"

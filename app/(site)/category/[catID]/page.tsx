...
export default async function Page({ params, }: {
  ...
  return (
    <div className="lg:border-5 bg-background py-20 px-5">
      <h1 className="text-5xl my-5 p-2"><Highlighter color="#EEBA58">{products[0]?.categories?.name || "0 product inserted"}</Highlighter></h1>

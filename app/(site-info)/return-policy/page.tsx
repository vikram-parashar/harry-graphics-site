  ...
  return (
    ...
    <h1 className="text-rosePine-iris text-4xl">
      ...
      <ul className="return-bullets">
        ...
        <li>Do you want to change the product? We send you the new product on the same day of receipt.</li>
        <li>Would you prefer us to refund your money? We will refund you within 3 days of receipt.</li>
